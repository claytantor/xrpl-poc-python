                ...
                {walletInfo ? <div className="flex flex-col">
                    ...
                    <div className="flex md:flex-row justify-between">
                        ...
                        <div className="grow flex flex-col md:flex-row md:justify-between items-center ">
                            <button className="flex sm:text-sm md:text-lg font-mono underline hover:text-pink-600 cursor-pointer" onClick={()=>window.location.href=`${xummConfig.xrp_endpoint_explorer}/accounts/${walletInfo.classic_address}`}>{walletInfo.classic_address}<BiLinkExternal className="items-center ml-1 mt-1"/></button>
